...
public class BooksController {
    ...
    public String home(Model model) {
        auditLogger.audit("Korisnik je pristupio listi knjiga");
    ...
    public String book(Model model, @PathVariable int id) {
        ...
        auditLogger.audit("Korisnik je otvorio detalje za knjigu sa id=" + id);
    ...
    public String CreateForm(Model model) {
        auditLogger.audit("Korisnik je otvorio formu za dodavanje knjige");
    ...
    public List<Book> search(@RequestParam("query") String query) throws SQLException {
        auditLogger.audit("Korisnik je pokrenuo pretragu sa upitom: '" + query + "'");
    ...
    public String createBook(NewBook book) {
        ...
        auditLogger.audit("Kreirana je nova knjiga sa id=" + id + ", naslov='" + book.getTitle() + "'");
